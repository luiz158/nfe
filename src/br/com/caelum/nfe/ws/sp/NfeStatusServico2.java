 ...
 *
 */
@WebServiceClient(name = "NfeStatusServico2", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", wsdlLocation = "file:./wsdls/sp/NfeStatusServico2.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL( "file:./wsdls/sp/NfeStatusServico2.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:./wsdls/sp/NfeStatusServico2.wsdl', retrying as a local file");
