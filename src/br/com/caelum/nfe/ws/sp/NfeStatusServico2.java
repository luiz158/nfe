...
/**
 * Servio destinado ˆ consulta do status do servio prestado pelo Portal da Secretaria de Fazenda Estadual.
 * 
 ...
 * 
 */
@WebServiceClient(name = "NfeStatusServico2", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", wsdlLocation = "file://psf/Home/dev/workspace/nfe-test/wsdl/sp/NfeStatusServico2.wsdl")
public class NfeStatusServico2
    extends Service
{

    private final static URL NFESTATUSSERVICO2_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(br.com.caelum.nfe.ws.sp.NfeStatusServico2 .class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = br.com.caelum.nfe.ws.sp.NfeStatusServico2 .class.getResource(".");
            url = new URL( "file://psf/Home/dev/workspace/nfe-test/wsdl/sp/NfeStatusServico2.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file://psf/Home/dev/workspace/nfe-test/wsdl/sp/NfeStatusServico2.wsdl', retrying as a local file");
