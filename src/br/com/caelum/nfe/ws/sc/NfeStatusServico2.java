 ...
 * 
 */
@WebServiceClient(name = "NfeStatusServico2", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", wsdlLocation = "file://psf/Home/dev/workspace/nfe-test/wsdl/sp/NfeStatusServico2-SC.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL( "file://psf/Home/dev/workspace/nfe-test/wsdl/sp/NfeStatusServico2-SC.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file://psf/Home/dev/workspace/nfe-test/wsdl/sp/NfeStatusServico2-SC.wsdl', retrying as a local file");
